/* Declare Parameters */
DECLARE @newBaseline BIT = 0 -- change to 0 when you don't want to replace the baseline, i.e. after initial run
  , @delay CHAR(8) = '00:00:30'; -- # OF SEC, change as needed
...
WHERE c.database_name = 'audit-dev'
