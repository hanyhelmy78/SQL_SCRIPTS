...
-- Create date: 6/07/2012
-- Description: Monitors currently running SQL Agent jobs and alerts admins if runtime passes set threshold
-- Updates: 11/07/2012	Changed Method for capturing currently running jobs to use master.dbo.xp_sqlagent_enum_jobs 1, ''
-- =============================================
...
SET @MailRecipients = 'hhelmy@aljomaihbev.com'
