...
EXEC sp_WhoIsActive_12_19
 ...
 EXEC sp_whoisactive_12_19 @get_transaction_info = 1, @sort_order = '[tran_log_writes] DESC'
 *****************************************************************************************
...
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.ROUTINES WHERE ROUTINE_NAME = 'sp_WhoIsActive_12_19')
    EXEC ('CREATE PROC dbo.sp_WhoIsActive_12_19 AS SELECT ''stub version, to be replaced''')
GO
...
*********************************************************************************************/
ALTER PROC dbo.sp_WhoIsActive_12_19
(
--~
