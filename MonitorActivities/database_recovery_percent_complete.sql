select session_id, PERCENT_COMPLETE, command, status, start_time, master.dbo.duration('s',datediff(s,start_time,getdate())) DURATION
...
/*
select count(*) COUNT, object_name PERFORMANCE_COUNTERS
