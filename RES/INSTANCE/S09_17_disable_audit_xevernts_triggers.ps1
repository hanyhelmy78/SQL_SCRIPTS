...
elseif ($exist -eq 1)
{
    ...
    {
        $confirm = Read-Host -Prompt "What would you like to disable from the list above? Please type ""Trigger"", ""Audit"", or ""ALL"" or ""Press any key"" to skip and ignore."
