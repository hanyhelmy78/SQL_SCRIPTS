...
begin
print('The service account: ' + @serviceaccount + ' lacks permission to access the registry path: ' + '"HKLM:\SOFTWARE\Microsoft\Microsoft SQL Server\'+@instance_version+'\SQLServerAgent"')
end
else
begin
select 
