...
EXEC	@return_value = [dbo].[sp_RestoreGene]
		@WithMoveDataFiles = N'K:\UserDB\MSSQL\',
		@WithMoveLogFile = N'I:\LogDB\MSSQL\',
		@WithRecovery=0,
		@WithReplace=1,
		@RestoreScriptOnly = 1,
		@ExcludeDiffAndLogBackups = 1
...
USE [master]
GO
/****** Object:  StoredProcedure [dbo].[sp_RestoreGene]    Script Date: 11/28/2016 11:24:29 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROC [dbo].[sp_RestoreGene]
(
...
BEGIN
	...
	DECLARE @ExcludeLogBackups_ BIT;
    SET @ExcludeLogBackups_ = @ExcludeLogBackups;
