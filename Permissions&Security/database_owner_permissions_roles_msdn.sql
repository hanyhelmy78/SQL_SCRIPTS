...
*	Web:		http://www.andreas-wolter.com	
*	Email:	a.wolter@SarpedonQualityLab.com	
* 	Version:	1.5
*			added server config database chaining ("x_dbc")
*			added detection and handling of Windows Groups 
*	Date:	03-2014	
* 	Democode:	No warranty of any kind
*	Do not re-publish without permission by the author
*********************************************************/
