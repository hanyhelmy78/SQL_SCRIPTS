...
BEGIN
    ...
    END
    ELSE
        SELECT 'No PAGELATCH_EX contention found on user databases at this time'
END
ELSE
BEGIN
...
/*
Recommendation:
Consider using below statement to enable OPTIMIZE_FOR_SEQUENTIAL_KEY for indexes on the table involved in the contention.
...
https://gohigh.substack.com/p/last-page-insert-contention
*/