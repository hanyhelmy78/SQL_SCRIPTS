...
@MinNumberOfPages int = 5000,
@MaxNumberOfPages int = NULL,
@SortInTempdb nvarchar(max) = 'Y',
@MaxDOP int = 4, -- Adjust to your workload
@FillFactor int = NULL,
@PadIndex nvarchar(max) = NULL,
@DataCompression nvarchar(max) = 'PAGE',
@WaitAtLowPriorityMaxDuration int = 10,
@WaitAtLowPriorityAbortAfterWait nvarchar(max) = NULL,
@Resumable nvarchar(max) = 'Y',
