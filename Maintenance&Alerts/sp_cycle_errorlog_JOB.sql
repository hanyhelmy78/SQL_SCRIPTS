...
/****** Object:  Job [sp_cycle_errorlog]    Script Date: 27/04/2015 8:49:59 AM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]]    Script Date: 27/04/2015 8:49:59 AM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [sp_cycle_errorlog]    Script Date: 27/04/2015 8:49:59 AM ******/
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'Monthly Schedule', 
		...
		@schedule_uid=N'1fdf465c-844f-4d63-b2a4-32d86918d411'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
