...
DECLARE @OperatorName sysname = N'SQL_DBA';
...
@job_id=N'00000000-0000-0000-0000-000000000000';
GO
EXEC msdb.dbo.sp_add_notification @alert_name=N'Severity 016', @operator_name=N'SQL_DBA', @notification_method = 1;
GO
--================================================================
EXEC msdb.dbo.sp_add_alert @name=N'Insufficient Resources Alert', 
		@message_id=0, 
		@severity=17, 
		@enabled=1, 
		...
		@job_id=N'00000000-0000-0000-0000-000000000000'
GO
EXEC msdb.dbo.sp_add_notification @alert_name=N'Insufficient Resources Alert', @operator_name=N'SQL_DBA', @notification_method = 1;
GO
--=================================================================
...
@job_id=N'00000000-0000-0000-0000-000000000000';
GO
EXEC msdb.dbo.sp_add_notification @alert_name=N'Severity 018', @operator_name=N'SQL_DBA', @notification_method = 1;
GO